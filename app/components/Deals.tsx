...
//   const dist = {
//     OPEN: allDeals.filter(d => d.status === 'OPEN').reduce((s, d) => s + d.amount, 0),
...
//         <div className="bg-primary h-full" style={{ width: `${(dist.OPEN / maxVal) * 100}%` }} title={`Open: $${dist.OPEN}`}></div>
...
//           <Link href="/deals?status=OPEN" className={getTabClass('OPEN')}>Open</Link>
...
//            {/* Collapsible Trigger moved here for cleaner look, or keep inline below */}
//         </div>
//       </div>
